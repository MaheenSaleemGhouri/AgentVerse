...
async def issue_api_key(
    ...
    issued = await service.issue_api_key(
        workspace_id=context.workspace_id, name=body.name, created_by_user_id=context.user_id
    )
...
async def revoke_api_key(
    ...
    await service.revoke_api_key(api_key_id=api_key_id, actor_user_id=context.user_id)
